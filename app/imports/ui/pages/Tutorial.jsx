    ...
    return (
      <div className='tutorial-background'>
        <Container>
          ...
          <Container className='line'/>
          <Image src='images/chatbot.png' size='huge' centered/>
          <Message>
          ...
          <Image src='images/question.png' size='huge' centered/>
          <Message>
          ...
          <Image src='images/message1.png' size='huge' centered/>
          <Message>
          ...
          <Image src='images/contact.png' size='huge' centered/>
          ...
          <Image src='images/feedbackP.png' size='huge' centered/>
          <Message>
          ...
          <Image src='images/submit.png' size='huge' centered/>
